    ...
    useEffect(() => {
        if (id) {
            const fetchdata = async () => {
                const result = await axios.get(`http://localhost:3036/getdata/${id}`, { withCredentials: true });
                    ...
                    <div className="book_product_list">
                        <div className="accordian_list">
                            <div className="accordian_header">
                                <p id="allbooks" >All Books</p>
                            </div>
                            <div className="accordian_header">
                                <p id="watchlist">WatchList</p >
                            </div>
                            <div className="accordian_header">
                                <p id="borrowed">Borrowed Books</p>
                            </div>
                            <div className="accordian_header">
                                <p id="pending">Pending Books</p>
                            </div>
                        </div>
                                    ...
                                    {issuedbook.map((data: finalissuebook) =>
                                        ...
                                        <div className="product-card-wrap-two">
                                            <div className="card-wrap">
                                                ...
                                                <p className="borrodt">Borrowed Date :</p>
                                                <p className="subdt">Submission Date :</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
